...
NETN FAFD is based on RPR-FOM v2.0 and any RPR-FOM based Federate is per definition NETN compliant. But that does definitely not meen fully compliant as you will discover later in this documentation.
